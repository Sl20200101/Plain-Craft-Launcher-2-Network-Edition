...
Public Class PageLinkMain
    Private Const MaintenanceEnabled As Boolean = True
...
#Region "状态管理"
    ...
    Private Sub LoaderInit() Handles Me.Initialized
        If MaintenanceEnabled Then Return
...
#End Region
    ...
    Public Sub SetMaintenanceTitle(Title As String)
        RunInUi(Sub()
                    If CardMaintenance Is Nothing Then Return
                    CardMaintenance.Title = Title
                End Sub)
    End Sub
