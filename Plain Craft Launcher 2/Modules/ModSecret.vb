...
#Region "杂项"
    ...
    '用于微软登录的 ClientId
    Public OAuthClientId As String = If(Environment.GetEnvironmentVariable("PCL_OAUTH_CLIENT_ID"), "00000000402b5328")
    'CurseForge API Key
    Public CurseForgeAPIKey As String = If(Environment.GetEnvironmentVariable("$2a$10$PcgXueTbMaXjvXU/T0zlNO7Rj4aAy7LMd9DGlpIXtUpBq0GifommK"), "")
