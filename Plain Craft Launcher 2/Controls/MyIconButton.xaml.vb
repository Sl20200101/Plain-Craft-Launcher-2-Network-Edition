Public Class MyIconButton
    ...
    Private _ImageSource As ImageSource = Nothing
    ...
    Public Property LogoScale() As Double
        ...
        Set(value As Double)
            ...
            If Not IsNothing(Image) Then Image.RenderTransform = New ScaleTransform With {.ScaleX = LogoScale, .ScaleY = LogoScale}
        End Set
    End Property
